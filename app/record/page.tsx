...
const encouragementMessages: Record<EncouragementStyle, Record<EncouragementKind, string[]>> = {
  gentle: {
    base: [
      ...
      '今天的状态被稳稳接住了，辛苦的地方也有了落点。',
      '你愿意把自己放在心上，这本身就很值得被肯定。',
      '又留下一点照顾自己的证据，慢慢来就很好。',
  ...
  minimal: {
    base: ['已保存。', '记录完成。', '今天已记录。', '保存好了。', '完成。', '已收好。'],
    lowSleep: ['已保存。今晚多休息。', '睡眠偏少，已记录。', '先休息。', '今晚早点睡。', '睡眠已标记。', '注意补觉。'],
    highAnxiety: ['已保存。先放慢。', '焦虑偏高，已记录。', '先稳住。', '减少消耗。', '情绪已记录。', '给自己缓冲。'],
    stomach: ['已保存。饮食清淡些。', '肠胃不适，已记录。', '先吃温和些。', '不适已记录。', '减轻负担。', '照顾肠胃。'],
    complete: ['记录完整。', '保存完成。', '信息很足。', '今天很清楚。', '完整保存。', '记录质量不错。'],
    exercise: ['运动已记录。', '已保存。', '活动已记录。', '身体有动。', '运动完成。', '节奏不错。'],
    gratitude: ['感恩已记录。', '已保存。', '温暖已保存。', '好事已留下。', '正向线索已记录。', '收好了。'],
    lazy: ['懒人记录已保存。', '已保存。', '原文已保留。', '归类完成。', '轻松完成。', '记录已收好。'],
  },
};
